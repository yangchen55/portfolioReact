    ...
    <Layout changeTheme={changeTheme}>
      <Container id="skills" className="container py-3 mb-5">
        ...
        <Row className="icons g-5 mt-3">
          ...
          <Col>
            <i className="fa-brands fa-square-js text-danger"></i>javascript
          </Col>
          <Col>
            <i className="fa-brands fa-figma text-"></i>figma
          </Col>
          <Col>
            <i className="fa-brands fa-react text-primary App-logo"></i>react
          </Col>
          <Col>
